...
task main(){
  ...
  const string sFileName = "GYRO250.txt";  // Our destination KML File
  ...
  while (true){
        ...
        WriteString(hFileHandle, nIoResult, str_x_val);    // Write it all to file.
        WriteString(hFileHandle, nIoResult, ",");    // Write it all to file.
        WriteString(hFileHandle, nIoResult, str_y_val);    // Write it all to file.
        WriteString(hFileHandle, nIoResult, ",");    // Write it all to file.
        WriteString(hFileHandle, nIoResult, str_z_val);    // Write it all to file.
